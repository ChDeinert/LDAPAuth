...
<div class="z-admin-content-pagetitle">
    ...
    <h3>{gt text="Import AD Groups"}</h3>
</div>

<div align="center"><b>{gt text='Current Group:'}</b> <span id="currentgroup">&nbsp;</span></div>
...
<div align="center" id="okbuttonarea" style="margin-top: 30px;" class="z-hide">
    <div class="z-buttonrow z-buttons z-center">
        <a href="{modurl modname='LDAPAuth' type='admin' func='groupImport'}" class="z-btgreen z-bt-ok">{gt text='OK'}</a>
    </div>
</div>
